...
Hier lernt er gerade, wirklich selbst zu programmieren, ganz ohne KI-Unterstützung. Vier eigene Ergebnisse bisher: eine To-Do-Liste (reines HTML/CSS/JavaScript — Aufgaben hinzufügen, per Klick abhaken, per Doppelklick löschen), eine Notizen-App mit React (useState, Vite — Notizen hinzufügen und löschen), MoviePicker mit React (useState, Vite, Fetch gegen die OMDb-API — Filme live suchen, Ergebnis anklicken für Details) und eine Wetter-App mit React (useState, useEffect, Vite, Fetch gegen die OpenWeatherMap-API — Stadt eingeben, aktuelles Wetter abrufen). Alle vier direkt auf der Projekte-Seite ausprobierbar, Quellcode öffentlich auf GitHub einsehbar. Weiterer Fortschritt live auf seinem Codecademy-Profil: https://www.codecademy.com/profiles/Meisam.dev
